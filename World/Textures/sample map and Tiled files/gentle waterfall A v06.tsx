...
<tileset version="1.9" tiledversion="1.9.1" name="gentle waterfall A v06" tilewidth="16" tileheight="16" tilecount="60" columns="6">
 <image source="../../19.07a Gentle Forest ($5 palettes)/gentle animations/gentle waterfall A v06.png" width="96" height="160"/>
 <tile id="0">
  <animation>
